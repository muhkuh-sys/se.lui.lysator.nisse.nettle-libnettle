...
IF((NOT DEFINED JONCHKI_PLATFORM_DIST_ID) OR (NOT DEFINED JONCHKI_PLATFORM_DIST_VERSION) OR (NOT DEFINED JONCHKI_PLATFORM_CPU_ARCH))
	...
	ELSEIF(CMAKE_SYSTEM_NAME STREQUAL "Linux")
		# Get the dpkg architecture.
		EXECUTE_PROCESS(COMMAND dpkg --print-architecture
		                RESULT_VARIABLE DPKG_ARCH_RESULT
		                OUTPUT_VARIABLE DPKG_ARCH_OUTPUT)
		IF(DPKG_ARCH_RESULT EQUAL 0)
			# Trim the command output.
			STRING(STRIP "${DPKG_ARCH_OUTPUT}" DPKG_ARCH_OUTPUT_TRIM)

			IF(DPKG_ARCH_OUTPUT_TRIM STREQUAL "amd64")
				SET(JONCHKI_PLATFORM_CPU_ARCH "x86_64")
			ELSE(DPKG_ARCH_OUTPUT_TRIM STREQUAL "amd64")
				SET(JONCHKI_PLATFORM_CPU_ARCH "${DPKG_ARCH_OUTPUT_TRIM}")
			ENDIF(DPKG_ARCH_OUTPUT_TRIM STREQUAL "amd64")
		ELSE(DPKG_ARCH_RESULT EQUAL 0)
		...
		ENDIF(DPKG_ARCH_RESULT EQUAL 0)
...
ELSE(JONCHKI_PLATFORM_DIST_ID STREQUAL "windows")
	SET(JONCHKI_PLATFORM "${JONCHKI_PLATFORM_DIST_ID}_${JONCHKI_PLATFORM_DIST_VERSION}_${JONCHKI_PLATFORM_CPU_ARCH}")
